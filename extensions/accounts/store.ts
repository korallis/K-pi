...
export class AccountsStore {
  ...
  constructor(agentDirectory = join(homedir(), ".pi", "agent")) {
  ...
  async putSlot(
    ...
    await this.mutate(async () => {
      const [document, secrets] = await Promise.all([
      ...
      const existingIndex = pool.slots.findIndex(
