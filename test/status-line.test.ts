...
import { renderIdleBrand, renderWorkingBrand } from "../extensions/status-line/brand.ts";
import {
  contextColor,
  ...
  formatCost,
  SEGMENT_SEPARATOR,
} from "../extensions/status-line/segments.ts";
...
test("default segment order matches the visual contract", () => {
  assert.deepEqual(DEFAULT_LEFT_SEGMENT_ORDER, [
    "brand",
    "model",
    "thinking",
    "path",
