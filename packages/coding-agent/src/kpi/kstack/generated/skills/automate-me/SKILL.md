...
The **k-mode** skill shows the shape. Read it for granularity. Don't copy its content; the user's rules are not the same as k-mode's.
...
- The **k-mode** skill: example of the output shape.
