...
| `model-ladder.md` | Role suggest lists (K3 = frontend) |
| `research.md` | Optional Exa and Perplexity research tools |
| `dune-architecture.md` | Folder-as-map + vertical slices |
| `minimalist.md` | Anti-over-engineering |
| `agents-bus.md` | Background Pi + communicate |
| `visual-targets.md` + `visual/` | Footer and Avid boards |
