...
12. `docs/roadmap.md` and `docs/implementation-plan.md` (historical baseline only)
13. `docs/remediation-research.md`
14. `docs/remediation-plan.md`

Then implement **only the lowest incomplete dependency-ready work package** in `remediation-plan.md`, starting at RP-00.
...
- After the WP: `pnpm test && pnpm lint && pnpm typecheck`. Check the WP DoD boxes in the same change.
