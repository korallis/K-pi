...
3. [`docs/AGENTS.md`](AGENTS.md)
4. [`docs/PRD.md`](PRD.md) — stories US-01–US-30
5. [`docs/spec.md`](spec.md)
6. [`docs/visual-targets.md`](visual-targets.md) + `docs/visual/*.jpg`
7. [`docs/kstack.md`](kstack.md) + [`docs/model-ladder.md`](model-ladder.md)
8. [`docs/research.md`](research.md) + [`docs/dune-architecture.md`](dune-architecture.md)
9. [`docs/minimalist.md`](minimalist.md) + [`docs/agents-bus.md`](agents-bus.md)
10. [`docs/roadmap.md`](roadmap.md) + [`docs/implementation-plan.md`](implementation-plan.md) — historical baseline only; their checkboxes are a build record, not completion evidence
11. [`docs/remediation-research.md`](remediation-research.md)
12. [`docs/remediation-plan.md`](remediation-plan.md) — active queue, RP-01A first
...
Do **one work package at a time**: the lowest incomplete dependency-ready `RP-##` in [`docs/remediation-plan.md`](remediation-plan.md), starting at RP-01A — the architecture reset that makes this repository a fork rather than a Pi package. Do not skip to K-stack or external research before the graph exists.
